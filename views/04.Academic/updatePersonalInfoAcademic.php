...
<section class="navigation">
    ...
    <!--====================== Academic Navbar PHP Start ===================-->

    <?php include_once("../../includes/04.Academic & Acc Supp/academicNavbar.php"); ?>

    <!--====================== Academic Navbar PHP End ===================-->
    ...
    <form action="#" method="post">
        <div class="container-fluid text-center  py-2 px-4">
            ...
            <div class="row p-4">
                ...
                <div class="col-lg-4 ">
                    <?php 
                        dropdownHead("User Type","user-type","userType","disable",$user_type);
                    ?>
                ...
                <div class="col-lg-4 ">
                    <?php 
                        dropdownHead("Department","department","dept","disable",$user_department);
                    ?>
