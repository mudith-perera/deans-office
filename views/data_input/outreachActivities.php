...
if(isset($_POST['submit'])){
    $desc   = strtolower(strip_tags($_POST['desc_outreach']));
    $year_outreach  = strtolower(strip_tags($_POST['year_outreach']));
    
    try{
        if($objCrud->insertOutAct($username,$desc,$year_outreach)){
...
if (isset($_POST['confirm'])){
    ...
    try {     
        $objCrud->deleteOutAct($username,$name);
    ...
    <form action="#" method="POST">
        <div class="container-fluid text-center  py-2 px-4">
            ...
            <div class="row p-4 mt-5">
                ...
                <div class="col-lg-4 ">
                    <?php textarea("desc_outreach",30,5,"Enter  Activity Details here...","required"); ?>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-4 ">
                    <?php inputField("number","year_outreach","Enter year here...","",""); ?>
                </div>
                <div class="col-lg-4 ">
                ...
                <div class="col-lg-12">
                    <table class="table table-striped my-5">
                        ...
                        <tbody>
                            ...
                            <?php
                                $data=$objCrud->getOutAct($username);
                                if($data){
                                    foreach($data as $row){?>
                            <tr>
