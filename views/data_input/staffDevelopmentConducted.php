...
if(isset($_POST['submit'])){
    $course_name_staff_conducted   = strtolower(strip_tags($_POST['course_name_staff_conducted']));
    $year_staff_conducted  = strtolower(strip_tags($_POST['year_staff_conducted']));
    $from_staff_conducted  = strtolower(strip_tags($_POST['from_staff_conducted']));
    $to_staff_conducted  = strtolower(strip_tags($_POST['to_staff_conducted']));
    $role_staff_conducted  = strtolower(strip_tags($_POST['role_staff_conducted']));
    $type  = strtolower(strip_tags($_POST['type']));
    $institute  = strtolower(strip_tags($_POST['institute']));
    
    try{
        if($objCrud->insertConStDev($username,$course_name_staff_conducted,$year_staff_conducted,$from_staff_conducted,$to_staff_conducted,$role_staff_conducted,$type,$institute)){
...
if (isset($_POST['confirm'])){
    ...
    try {     
        $objCrud->deleteConStDev($username,$name);
...
?>
    ...
    <form action="#" method="POST">
        <div class="container-fluid text-center  py-2 px-4">
            ...
            <h1>Conducted Staff Development Programs</h1>
            ...
            <div class="row p-4 mt-5">
                <div class="col-lg-2">
                    ...
                    <?php label("programme-name"," Name"); ?>
                </div>
                <div class="col-lg-4 ">
                    <?php inputField("text","course_name_staff_conducted","Enter Programme name here...","",""); ?>
                </div>

                <div class="col-lg-2">
                    <?php label("year","Conducted Year") ?>

                </div>
                <div class="col-lg-4 ">
                    <?php inputField("number","year_staff_conducted","Enter  Year here...","",""); ?>
                </div>
            </div>
            ...
            <div class="row p-4">
                ...
                <div class="col-lg-2 ">
                    <?php inputField("date","from_staff_conducted","From","","");  ?> <br> <small
                        class="form-text text-muted">From</small>
                </div>

                <div class="col-lg-2 ">
                    <?php inputField("date","to_staff_conducted","To","",""); ?> <br> <small
                ...
                <div class="col-lg-4 ">
                    <?php inputField("text","role_staff_conducted","Enter role  here...","",""); ?>
                </div>
            ...
            <div class="row p-4">
                ...
                <div class="col-lg-4 ">
                    <?php inputField("text","institute","Enter Conducted Institute here...","",""); ?>
                </div>
                <div class="col-lg-4 ">
                ...
                <div class="col-lg-12">
                    <table class="table table-striped my-5">
                        <thead class="bg-success text-light">
                            <?php conductedStaffDevHead();?>

                        </thead>
                        <tbody>

                            <?php
                                $data=$objCrud->getConStDev($username);
                                if($data){
                                    foreach($data as $row){?>
                            <tr>
                                <td><?php echo $row['name']?></td>
                                <td><?php echo $row['con_year']?></td>
