...
if(isset($_POST['submit'])){
    $activity_name   = strtolower(strip_tags($_POST['desc_national']));
    $year  = strtolower(strip_tags($_POST['year_national']));
    
    try{
        if($objCrud->insertConl($username,$activity_name,$year)){
...
if (isset($_POST['confirm'])){
    ...
    try {
        if ($name!=null) {
            ...
            $objCrud->deleteConl($username,$name);
...
?>
    ...
    <form action="#" method="POST">
        <div class="container-fluid text-center  py-2 px-4">
            ...
            <h1>Contribution of National Level</h1>
            ...
            <!--  Contribution of National Level -->
            <div class="row p-4 mt-5">
                ...
                <div class="col-lg-4 ">
                    <?php textarea("desc_national",30,5,"Enter  Activity  here...","required"); ?>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-4 ">
                    <?php inputField("number","year_national","Enter year here...","",""); ?>
                </div>
                <div class="col-lg-4 ">
                ...
                <div class="col-lg-12">
                    <table class="table table-striped my-5">
                        <thead class="bg-success text-light">
                            <?php  contributionNationalHead();?>

                        </thead>
                        <tbody>

                            <?php
                                $data=$objCrud->getConl($username);
                                if($data){
                                    foreach($data as $row){?>
                            <tr>
                                <td><?php echo $row['cn_activity']?></td>
