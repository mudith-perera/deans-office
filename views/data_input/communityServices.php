...
if(isset($_POST['submit'])){
    $activity_name   = strtolower(strip_tags($_POST['desc_community']));
    $year  = strtolower(strip_tags($_POST['year_community']));
    
    try{
        if($objCrud->insertCommunityServ($username,$activity_name,$year)){
...
if (isset($_POST['confirm'])){
    ...
    try {
        if ($name!=null) {
            ...
            $objCrud->deleteCommunityServ($username,$name);
    ...
    <form action="#" method="POST">
        <div class="container-fluid text-center  py-2 px-4">
            ...
            <div class="row p-4 mt-5">
                ...
                <div class="col-lg-4 ">
                    <?php textarea("desc_community",30,5,"Enter  Activity Details here...","required"); ?>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-4 ">
                    <?php inputField("number","year_community","Enter year here...","",""); ?>
                </div>
                <div class="col-lg-4 ">
                ...
                <div class="col-lg-12">
                    <table class="table table-striped my-5">
                        <thead class="bg-success text-light">
                            <?php communityServicesHead(); ?>

                        </thead>
                        <tbody>

                            <?php
                            $data=$objCrud->getCommunityServ($username);
                            if($data){
                                foreach($data as $row){?>
                            <tr>
                                <td><?php echo $row['comm_srv_act']?></td>
