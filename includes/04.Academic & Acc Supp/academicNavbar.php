...
<nav class="navbar navbar-expand-md navbar-dark bg-success z">
        <div class="d-flex navContent order-0">
            <a class="navbar-brand mr-1" href="./../04.Academic/academicWelcome.php">
                <h3><i class="far fa-user" style="margin: 0 10px 0 0;"></i>Academic <br><span style="font-size:1rem;">'.ucwords($_SESSION['fullname']).'</span> </h3>
            </a>
        ...
        <div class="navbar-collapse collapse text-center justify-content-center mt-2  order-2" id="collapsingNavbar">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item mx-4">
                    <a class="nav-link text-light updatePersonalInfo" href="./../04.Academic/updatePersonalInfoAcademic.php">
